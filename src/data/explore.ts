...
export const EXPLORE_VENUES: Venue[] = [
  {
    ...
    category: 'familyFun',
    image: venueImages.theGreatEscape,
    latitude: 49.1047,
    longitude: -122.6608,
    rating: 4.8,
    reviewCount: 412,
  ...
  },
  {
    ...
    category: 'familyFun',
    image: venueImages.canadianMuseumOfFlight,
    latitude: 49.1008,
    longitude: -122.6308,
    rating: 4.7,
    reviewCount: 318,
  ...
  },
  {
    ...
    category: 'familyFun',
    image: venueImages.twilightDriveIn,
    latitude: 49.0169,
    longitude: -122.4848,
    rating: 4.6,
    reviewCount: 523,
  ...
  },
  {
    ...
    category: 'liveShows',
    image: venueImages.langleyEventsCentreAlt,
    latitude: 49.1468,
    longitude: -122.6697,
    rating: 4.5,
    reviewCount: 1204,
  ...
  },
  {
    ...
    category: 'liveShows',
    image: venueImages.theatreInTheCountry,
    latitude: 49.1037,
    longitude: -122.6578,
    rating: 4.8,
    reviewCount: 287,
  ...
  },
  {
    ...
    category: 'liveShows',
    image: venueImages.spiritSquare,
    latitude: 49.1041,
    longitude: -122.6602,
    rating: 4.3,
    reviewCount: 156,
  ...
  },
  {
    ...
    category: 'liveShows',
    image: venueImages.roseGellertHall,
    latitude: 49.0908,
    longitude: -122.6609,
    rating: 4.6,
    reviewCount: 134,
  ...
  },
  {
    ...
    category: 'liveShows',
    image: venueImages.coastConventionCentre,
    latitude: 49.1045,
    longitude: -122.6607,
    rating: 4.4,
    reviewCount: 445,
  ...
  },
  {
    ...
    category: 'nightlife',
    image: venueImages.rendezvousPub,
    latitude: 49.1038,
    longitude: -122.6692,
    rating: 4.3,
    reviewCount: 289,
  ...
  },
  {
    ...
    category: 'nightlife',
    image: venueImages.newlandsBarGrill,
    latitude: 49.0898,
    longitude: -122.6635,
    rating: 4.2,
    reviewCount: 201,
...
export function getExploreVenues(
  category: ExploreCategory,
): Venue[] {
  if (category === 'all') {
    return EXPLORE_VENUES;
  }
  return EXPLORE_VENUES.filter(
