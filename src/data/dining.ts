...
export const DINING_MENU: MenuItem[] = [
  {
    ...
    price: 18,
    prepTimeMin: 20,
    image: menuImages.classicCanadianBreakfast,
    category: 'breakfast',
  },
  {
    ...
    price: 17,
    prepTimeMin: 15,
    image: menuImages.smokedSalmonBagel,
    category: 'breakfast',
  },
  {
    ...
    price: 15,
    prepTimeMin: 18,
    image: menuImages.blueberryPancakeStack,
    category: 'breakfast',
  },
  {
    ...
    price: 16,
    prepTimeMin: 15,
    image: menuImages.avocadoBreakfastToast,
    category: 'breakfast',
  },
  {
    ...
    price: 17,
    prepTimeMin: 20,
    image: menuImages.breakfastBurrito,
    category: 'breakfast',
  },
  {
    ...
    price: 24,
    prepTimeMin: 25,
    image: menuImages.cascadesSignatureBurger,
    category: 'lunch',
  },
  {
    ...
    price: 21,
    prepTimeMin: 18,
    image: menuImages.grilledChickenCaesarSalad,
    category: 'lunch',
  },
  {
    ...
    price: 27,
    prepTimeMin: 25,
    image: menuImages.pacificSalmonBowl,
    category: 'lunch',
  },
  {
    id: 'steak-sandwich',
    ...
    price: 23,
    prepTimeMin: 22,
    image: menuImages.steakSandwich,
    category: 'lunch',
  },
  {
    ...
    price: 19,
    prepTimeMin: 18,
    image: menuImages.margheritaFlatbread,
    category: 'lunch',
  },
  {
    ...
    price: 42,
    prepTimeMin: 35,
    image: menuImages.premiumRibeyeSteak,
    category: 'dinner',
  },
  {
    ...
    price: 48,
    prepTimeMin: 40,
    image: menuImages.atlanticLobsterTail,
    category: 'dinner',
  },
  {
    ...
    price: 34,
    prepTimeMin: 30,
    image: menuImages.herbCrustedSalmon,
    category: 'dinner',
  },
  {
    id: 'chicken-supreme',
    ...
    price: 29,
    prepTimeMin: 28,
    image: menuImages.chickenSupreme,
    category: 'dinner',
  },
  {
    ...
    price: 28,
    prepTimeMin: 25,
    image: menuImages.truffleMushroomPasta,
    category: 'dinner',
  },
];
